...
function start(r, l) {
    ...
    var timerInterval = setInterval(function () {
        var elapsedTime = Math.floor((performance.now() - startTime) / 1000); // Calculate elapsed time in seconds
        min = Math.floor(elapsedTime / 60); // Calculate minutes
        sec = elapsedTime % 60; // Calculate seconds
